package com.coc.suncode.core.system.screencapture
...
object AutoGrantTool {
    private val SERVICE_PATH: String
        get() = "com.coc.suncode/${MyAccessibilityService::class.java.name}"
    ...
    fun forceEnableAccessibility(): Boolean {
        try {
            ...
            val strippedList = currentServices
                .split(":")
                .filter { !it.startsWith("com.coc.suncode/") && it.isNotEmpty() && it != "null" }
                .joinToString(":")
